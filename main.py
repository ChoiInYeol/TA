...
def main():
    ...
    combined_df.to_csv('combined_indicators.csv')
    ...
    # 신호 성과 분석
    performance = signal_generator.calculate_signal_performance(all_signals)
    summary = signal_generator.get_signal_summary(performance).round(4)
    
    
    all_signals.to_csv('trading_signals.csv')
    summary.to_csv('trading_summary.csv')
